...
let openBracket = document.getElementById("btnOpenBracket");
let closeBracket = document.getElementById("btnCloseBracket");
let sqrt = document.getElementById("btnSqrt");
...
openBracket.addEventListener('click' , clickOpenBracket);
closeBracket.addEventListener('click', clickCloseBracket);
sqrt.addEventListener('click', clickBtnSqrt);
